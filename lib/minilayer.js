...
var isMac = system.platform === "darwin";
var miniPanel;
var miniPanelView;
var lastClose = null;
...
exports.create = function (x, y, onInit) {
    ...
    if (miniPanel) {
        ...
        miniPanel.port.on('menuEntryClick', function (text, languagePair) {
            translator.miniMenuEntryClick(miniPanel, text, languagePair);
        });
        miniPanel.port.on('resultClick', function (href) {
            miniPanel.hide();
            translator.miniResultClick(href);
        });
    }
