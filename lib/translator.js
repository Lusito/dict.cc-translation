...
function startInpageTranslation(params, languagePair, callback) {
    ...
    utils.requestHTML(url, true, function (doc) {
        ...
        for (var i = 0; i < elements.length; i++) {
            links.push({
                href: elements[i].href + '&lp=' + languagePair,
...
function startTranslation(params, openMethod, multiWindow) {
    switch (openMethod) {
...
exports.run = function (text, languagePair, isQuick) {
    ...
    startTranslation(params, openMethod, multiWindow);
};
